...
public class InventoryHandler {
    ...
    public static void setFFA(Player p) {
        p.teleport(Main.getInstance().mapswitcher.getSpawn());
    ...
    public static void update(Player p) {
        ...
        if(level==1) {
            ...
            p.getInventory().setChestplate(new ItemBuilder(Material.GOLD_CHESTPLATE).setName("§dGoldbrustpanzer").setUnbreakable().build());
        } else if(level==13) {
            ...
            p.getInventory().setChestplate(new ItemBuilder(Material.GOLD_CHESTPLATE).setName("§dGoldbrustpanzer").addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL,1).setUnbreakable().build());
        } else if(level==18) {
            p.getInventory().setBoots(new ItemBuilder(Material.GOLD_BOOTS).setName("§dGoldstiefel").addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL,1).setUnbreakable().build());
        } else if(level==19) {
            p.getInventory().setHelmet(new ItemBuilder(Material.GOLD_HELMET).setName("§dGoldhelm").addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL,1).setUnbreakable().build());
        } else if(level==20) {
            p.getInventory().setLeggings(new ItemBuilder(Material.GOLD_LEGGINGS).setName("§dGoldhose").addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL,1).setUnbreakable().build());
        }
            ...
            p.getInventory().setChestplate(new ItemBuilder(Material.CHAINMAIL_CHESTPLATE).setName("§dKettenbrustpanzer").setUnbreakable().build());
        } else if(level==23) {
            ...
            p.getInventory().setChestplate(new ItemBuilder(Material.CHAINMAIL_CHESTPLATE).setName("§dKettenbrustpanzer").addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL,1).setUnbreakable().build());
        } else if(level==28) {
            p.getInventory().setBoots(new ItemBuilder(Material.CHAINMAIL_BOOTS).setName("§dKettenstiefel").addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL,1).setUnbreakable().build());
        } else if(level==29) {
            p.getInventory().setHelmet(new ItemBuilder(Material.CHAINMAIL_HELMET).setName("§dKettenhelm").addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL,1).setUnbreakable().build());
        } else if(level==30) {
            p.getInventory().setLeggings(new ItemBuilder(Material.CHAINMAIL_LEGGINGS).setName("§dKettenhose").addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL,1).setUnbreakable().build());
        }
            ...
            p.getInventory().setChestplate(new ItemBuilder(Material.IRON_CHESTPLATE).setName("§dEisenbrustpanzer").setUnbreakable().build());
        } else if(level==33) {
            ...
            p.getInventory().setChestplate(new ItemBuilder(Material.IRON_CHESTPLATE).setName("§dEisenbrustpanzer").addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL,1).setUnbreakable().build());
        } else if(level==38) {
            p.getInventory().setBoots(new ItemBuilder(Material.IRON_BOOTS).setName("§dEisenstiefel").addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL,1).setUnbreakable().build());
        } else if(level==39) {
            p.getInventory().setHelmet(new ItemBuilder(Material.IRON_HELMET).setName("§dEisenhelm").addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL,1).setUnbreakable().build());
        } else if(level==40) {
            p.getInventory().setLeggings(new ItemBuilder(Material.IRON_LEGGINGS).setName("§dEisenhose").addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL,1).setUnbreakable().build());
        }
            ...
            p.getInventory().setChestplate(new ItemBuilder(Material.DIAMOND_CHESTPLATE).setName("§dDiamantbrustpanzer").setUnbreakable().build());
        } else if(level==43) {
            ...
            p.getInventory().setChestplate(new ItemBuilder(Material.DIAMOND_CHESTPLATE).setName("§dDiamantbrustpanzer").addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL,1).setUnbreakable().build());
        } else if(level==48) {
            p.getInventory().setBoots(new ItemBuilder(Material.DIAMOND_BOOTS).setName("§dDiamantstiefel").addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL,1).setUnbreakable().build());
        } else if(level==49) {
            p.getInventory().setHelmet(new ItemBuilder(Material.DIAMOND_HELMET).setName("§dDiamanthelm").addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL,1).setUnbreakable().build());
        } else if(level==50) {
            p.getInventory().setLeggings(new ItemBuilder(Material.DIAMOND_LEGGINGS).setName("§dDiamanthose").addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL,1).setUnbreakable().build());
        }
